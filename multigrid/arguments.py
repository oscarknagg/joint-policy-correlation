...
def add_training_arguments(parser: argparse.ArgumentParser) -> argparse.ArgumentParser:
    ...
    parser.add_argument('--diversity-window', default=2000, type=int)
    parser.add_argument('--diversity-interval', default=1000, type=int)
    parser.add_argument('--diversity-incremental', default=True, type=get_bool)
    parser.add_argument('--diversity-epochs', default=1, type=int)
