...
mazes = generate_random_mazes(num_envs, height, width, complexity, density, 'cpu')
respawns = generate_random_respawns(mazes, num_respawns, 2)

# from config import PATH
# np.save(f'{PATH}/data/pathing-small2a.npy', mazes.cpu().numpy())
# np.save(f'{PATH}/data/respawn-small2a.npy', respawns.cpu().numpy())
